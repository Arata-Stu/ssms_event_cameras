...
for dt in event_frame_dts:
    command = f"""
    python3 RVT/train.py model=rnndet dataset=gen1 dataset.path={data_dir} wandb.project_name=RVT_ssm_gen1_histo{dt} \
    ...
    """
    print(f"Running command for gen1 event_frame_dt={dt}_nbins=10")
